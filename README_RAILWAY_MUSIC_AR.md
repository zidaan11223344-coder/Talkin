...
## قاعدة نشر الأغاني الجديدة
- `تشغيل اسم الأغنية` و`شغل اسم الأغنية`: تشغيل داخل الغرفة الحالية فقط.
- `.تشغيل اسم الأغنية`: تشغيل داخل الغرفة الحالية فقط.
- `.sa اسم الأغنية`: الأمر الوحيد الذي ينشر الأغنية والصوت وكود التفاعلات في جميع الغرف.
- التفاعلات `lk/lv/dl/cm/report` ترتبط فقط بمنشور `.sa`.
